...
per_dir = f"{args.out_dir}/{tag}"
args.out_dir = f"{args.out_dir}/{tag}/{args.direction}/{args.ptm_name}"
...
data = IrData(total_size=args.total_size, direction=tag)
address2id = data.get_address2id(fpath=f"{per_dir}/{args.direction}/address2id.json")
